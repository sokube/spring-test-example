package io.sokube.greetings.servicetest.glue;
...
public class GreetingsCreationSteps {
    ...
    public void a_greeting_is_created() {
        ...
        assertThat(message.type()).isEqualTo(URI.create("https://sokube.io/greetings/events/greeting-created"));
...
//        var message = record.value();
//        assertThat(message).isNotNull();
//        assertThat(message.type()).isEqualTo(URI.create("https://sokube.io/greetings/events/greeting-updated"));
