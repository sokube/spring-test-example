package io.sokube.greetings.stat.bootstrap.glue;

import io.cucumber.java.en.Then;
import io.cucumber.java.en.When;
import io.cucumber.spring.CucumberContextConfiguration;
import io.sokube.greetings.message.GreetingsMessage;
import io.sokube.greetings.stat.persistence.CounterRepository;
...
import static io.sokube.greetings.stat.bootstrap.glue.GreetingsStatsSteps.topic;
...
public class GreetingsStatsSteps {
    ...
    public void i_create_a_greetings() {
        ...
        assertThat(testMessage.type()).isEqualTo(URI.create("https://sokube.io/greetings/events/greeting-created"));
    ...
    private Consumer<String, GreetingsMessage> createConsumer() {
        ...
        consumerProps.put(JsonDeserializer.TRUSTED_PACKAGES, "io.sokube.*");
