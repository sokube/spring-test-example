...
import io.sokube.greetings.stat.message.handler.GreetingMessagePayloadHandler;
...
//    private ObjectMapper jsonMapper;
    ...
    MessagePact createPact(MessagePactBuilder builder) {
        PactDslJsonBody payload = new PactDslJsonBody()
                .stringMatcher("type", "^https://sokube.io/greetings/events/.*", "https://sokube.io/greetings/events/greeting-created")
